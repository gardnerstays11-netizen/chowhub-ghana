  ...
  const listingsData = [
    {
      ...
      features: ["wifi", "outdoor_seating", "live_music", "parking"], occasions: ["family_outing", "birthday_dinner", "casual_hangout"], dressCode: "casual",
    ...
    },
    {
      ...
      features: ["takeaway", "group_dining"], occasions: ["casual_hangout", "business_lunch"], dressCode: "casual",
    ...
    },
    {
      ...
      features: ["live_music", "outdoor_seating", "parking"], occasions: ["date_night", "casual_hangout", "group_outing"], dressCode: "casual",
    ...
    },
    {
      ...
      features: ["takeaway"], occasions: ["casual_hangout"], dressCode: "casual",
    ...
    },
    {
      ...
      features: ["rooftop", "live_music", "cocktails", "dress_code", "parking", "wifi"], occasions: ["date_night", "birthday_dinner", "anniversary", "business_dinner"], dressCode: "smart_casual",
      acceptsReservations: true, acceptsOrders: false, isFeatured: true, isVerified: true, status: "active",
    ...
    },
    {
      ...
      features: ["wifi", "group_dining", "takeaway"], occasions: ["family_outing", "business_lunch", "casual_hangout"], dressCode: "casual",
    ...
    },
    {
      ...
      features: ["wifi", "outdoor_seating", "power_outlets", "parking"], occasions: ["business_lunch", "casual_hangout"], dressCode: "casual",
      acceptsReservations: false, acceptsOrders: true, isFeatured: true, isVerified: true, status: "active",
    ...
    },
    {
      ...
      features: ["group_dining", "takeaway", "parking"], occasions: ["family_outing", "casual_hangout"], dressCode: "casual",
      acceptsReservations: true, acceptsOrders: true, isFeatured: false, isVerified: true, status: "active",
      averageRating: 4.6, totalReviews: 1,
    },
    {
      ...
      features: ["beachfront", "live_music", "cocktails", "outdoor_seating", "parking"], occasions: ["date_night", "birthday_dinner", "group_outing", "anniversary"], dressCode: "casual",
      acceptsReservations: true, acceptsOrders: false, isFeatured: true, isVerified: true, status: "active",
      averageRating: 4.4, totalReviews: 1,
    },
    {
